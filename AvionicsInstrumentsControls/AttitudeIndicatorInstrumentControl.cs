...
/*****************************************************************************/
/* Changelog:
 * Added a few functions at line 118-127 to separate the original function at line 110
*/
using System;
...
namespace AvionicsInstrumentControlDemo
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        {
            PitchAngle = aircraftPitchAngle * Math.PI / 180;
            RollAngle = aircraftRollAngle * Math.PI / 180;

            this.Refresh();
        }
        //below are modified/added
        public void SetPitchParameter(double aircraftPitchAngle) //arguments need to be in radians
        {
            PitchAngle = aircraftPitchAngle;
            this.Refresh();
        }
        public void SetRollAngleParameter(double aircraftRollAngle) //arguments need to be in radians
        {
