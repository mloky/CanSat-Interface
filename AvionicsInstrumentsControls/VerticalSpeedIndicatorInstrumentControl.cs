...
namespace AvionicsInstrumentControlDemo
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AvionicsInstrumentControlDemo.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.VerticalSpeedIndicator_Background_edited);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            double alphaNeedle = InterpolPhyToAngle(verticalSpeed, -6, 6, 120, 420);
