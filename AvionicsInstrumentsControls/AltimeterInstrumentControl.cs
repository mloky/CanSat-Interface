...
namespace AvionicsInstrumentControlDemo
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AvionicsInstrumentControlDemo.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Altimeter_Background_edited);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            //Changed positioning of counter
            //Point ptCounter = new Point(35,135); original
            Point ptCounter = new Point(75, 135);
            ...
            //changes made to altitude
            double alphaSmallNeedle = InterpolPhyToAngle(altitude / 10, 0, 10, 0, 359);
            double alphaLongNeedle = InterpolPhyToAngle(altitude % 10, 0, 10, 0, 359);

            float scale = (float)this.Width / bmpCadran.Width;

            // display counter
            ScrollCounter(pe, bmpScroll, 3, (int)altitude, ptCounter, scale);
