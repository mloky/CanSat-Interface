...
/*****************************************************************************/
/* Changelog:
 * Added a few functions to line 125-134 to separate the original function at line 117
*/
...
namespace AvionicsInstrumentControlDemo
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        public void SetaircraftTurnRate(float aircraftTurnRate)
        {
            TurnRate = aircraftTurnRate;
            this.Refresh();
        }
        public void SetAircraftTurnQuality(float aircraftTrunQuality)
        {
            TurnQuality = aircraftTrunQuality;
            this.Refresh();
        }
